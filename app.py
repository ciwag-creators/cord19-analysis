...
def load_data():
    try:
        ...
        st.error("❌ sample.csv file not found. Please make sure it's in the same directory as this script.")
        st.info("💡 You can create sample.csv by running the sample creation script or download a sample from the CORD-19 dataset.")
        return None
...
if df is not None:
    ...
    1. Download or create the `sample.csv` file 
    2. Place it in the same directory as this script
    3. Install the required packages: `pip install streamlit pandas matplotlib seaborn wordcloud`
    4. Run the application: `streamlit run app.py`
    
    **To create sample.csv:**
    - Use the sample creation script provided
    - Or download a sample from the CORD-19 dataset
    """)
